...
public class BuildSymbolTableVisitor implements Visitor
{
    ...
    private void redefError(String name)
    {
        System.err.println("Multiply defined identifier " + name + " at line " + 10 + ", character " + 10);
        errorDetected = true;
    }
    ...
    public void visit(MethodDecl n)
    {
        ...
        for ( int i = 0; i < n.fl.size(); i++ )
        {
            ...
            {
                redefError(n.fl.elementAt(i).i.toString());
            }
